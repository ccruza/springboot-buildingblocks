insert into user values(101,'carlos.cruz@pe.ey.com','Carlos','Cruz','admin','SSN-101','ccruz');
insert into user values(102,'juan.perez@pe.ey.com','Juan','Perez','admin','SSN-102','jperez');
insert into user values(103,'maria.db@pe.ey.com','Maria','DB','admin','SSN-103','mariadb');
